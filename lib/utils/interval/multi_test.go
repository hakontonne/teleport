...
// TestMultiInvervalPush verifies the expected behavior of MultiInterval.Push, both in terms of
...
// TestMulitIntervalFireNow verifies the expected behavior of MultiInterval.FireNow.
func TestMuliIntervalFireNow(t *testing.T) {
	t.Parallel()
