...
func (e *EditCommand) TryRun(ctx context.Context, cmd string, client auth.ClientI) (match bool, err error) {
	...
	// TODO(zmb3): this won't work for enterprise resources, because
	// there's a separate ResourceCommandE struct for enterprise
	// (this will be easier when enterprise tctl goes away)
	rc := &ResourceCommand{
