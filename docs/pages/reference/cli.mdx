...
| [Windows Desktop](../desktop-access/getting-started.mdx) | `windowsdesktop` | Provides Windows Desktop access. |
...
Allows for access to Teleport resources via a local TLS proxy in single-port mode.
