...
Starting with Teleport 11, you can install Active Directory and configure Teleport Desktop Access through the web UI. See [Desktop Discovery](discovery.mdx) for more information.
